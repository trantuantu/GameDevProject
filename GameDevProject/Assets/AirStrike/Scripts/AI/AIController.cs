         ...
         // Ok in range
            ...
            {// is in Direction ?
             // Ok Can Shoot them.
                ...
                {// Make it delay and unstable shooting by Attack rate (if you set Attack Rate to 100 this AI will alway shooting like a brutal)
                    flight.WeaponControl.LaunchWeapon(WeaponSelected);// FIRE A GUN!!!
                }
                if (distance < DistanceAttack / 3)
                {// if too close the target , let's turning back a while.
                    turnPosition();
                }
